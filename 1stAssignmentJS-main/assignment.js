// ১. Variable কি ?
Ans: একটা তথ্য সে জায়গায় রাখা. যা প্রয়োজন মত বের করা যাবে.
...
Ans: কোন সংখ্যা দ্বারা ভেরিয়েবল ডিক্লেয়ার করাকে নাম্বারটাই ভেরিয়েবল বলে.
     var number = ;
     console.log(number)
// ৫. Boolan type variable  কি ও কি ভাবে লিখতে হয় ?
Ans: true এবং false এর ব্যবহার.
     var BoolType = false ; 
...
Ans: var lotary = Math.random()*100;
     console.log(lotary);
